...
data = np.load("cache/G_history_samples/N16x16/N16x16_C20_S100_nshNone_DW1_init-default.npz", allow_pickle=True)
...
#data = np.load('cache/G_history_samples/N16x16/N16x16_C20_S1_nshNone_DW1_init-default_store-full_DW_mixed_injection.npz', allow_pickle=True)
